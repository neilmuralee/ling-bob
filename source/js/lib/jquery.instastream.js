            ...
            success: function(data) {
                ...
                for (var i = 0; i < $nbrResults; i++) {
                    if (j < 20) {
                        ...
                        if (data.data[j].comments.count == 1) {
                        ...
                        $('.slider-content').append("<div class='frame'><a href='" + data.data[j].link + "'><img src='" + data.data[j].images.standard_resolution.url + "' alt='" + myCaption + "'></a><footer class='frame-footer'><span class='frame-title'><span class='frame-likes'>" + data.data[j].likes.count + " " + likeLabel + "</span> <span class='frame-comments'>" + data.data[j].comments.count + " " + commentLabel + "</span> <span class='frame-date'>" + data.data[j].created_time.timeconverter() + "</span></span><span class='frame-caption'>" + myCaption + "</span></footer></div>");
                        j++;
                        $slideStatus = j;
                    }
                };
